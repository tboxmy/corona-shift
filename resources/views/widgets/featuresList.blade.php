<div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4 py-5">
    ...
    <div>
        <h4 class="fw-bold mb-0">Hourly Schedule</h4>
        <p>List schedule for a week, showing by hours each day</p>
        <a href="/eventsHourly" class="stretched-link">Staff shift listing by Employee with CSS and JS</a>
    </div>
    </div>
    <div class="col d-flex align-items-start">
    ...
    <div>
        ...
        <a href="/events" class="stretched-link">Staff shift listing by Department with CSS and JS</a>
    </div>
    </div>
    <div class="col d-flex align-items-start">

                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                            ...
                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    ...
                                    <ol>
                                        ...
                                        <li><a href="/events/view2">Staff shift listing by Employee with CSS and JS</a>
                                        <li><a href="/events/view3">Staff shift listing by Department with CSS and JS</a>
                                    </ol>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://tboxmy.blogspot.com" class="underline text-gray-900 dark:text-white">Blogspot</a></div>
                            </div>
